...
export default function LandingPage() {
  ...
  const plans = [
    {
      ...
      features: ["1 Usuario Admin", "50 Recepciones al mes", "Presupuestos básicos", "Soporte comunitario"],
      cta: "Comenzar Gratis",
      highlight: false
    },
    {
      ...
      features: ["5 Usuarios Técnicos", "Recepciones ilimitadas", "Personalización de PDFs", "Auditoría completa", "Soporte prioritario"],
    ...
    },
    {
      ...
      features: ["Usuarios Ilimitados", "Multi-Sucursal", "Acceso a API REST", "Integración CRM", "Account Manager"],
  ...
  return (
    <div className="min-h-screen bg-background font-sans selection:bg-primary/30">
      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-border/40">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-xl font-black tracking-tighter">AppTaller</span>
          </div>
          
          <div className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-sm font-bold text-muted-foreground hover:text-primary transition-colors">Funciones</a>
            <a href="#planes" className="text-sm font-bold text-muted-foreground hover:text-primary transition-colors">Precios</a>
            {isAuthenticated ? (
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center space-y-8">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight max-w-4xl mx-auto leading-[1.1] animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
            Potencia tu taller con un <span className="text-transparent bg-clip-text bg-linear-to-r from-primary to-blue-400 not-italic">Software Clase Mundial.</span>
          </h1>
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto font-medium animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
            La plataforma SaaS diseñada para organizar recepciones, generar reportes de falla y controlar presupuestos con precisión técnica.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
            <Button size="lg" asChild className="rounded-2xl px-10 py-7 text-lg font-bold shadow-2xl shadow-primary/30 hover:scale-[1.02] active:scale-[0.98] transition-all">
              <Link to="/register-company">Comenzar Gratis <Zap className="ml-2 h-5 w-5 fill-current" /></Link>
            </Button>
            <Button size="lg" variant="outline" asChild className="rounded-2xl px-10 py-7 text-lg font-bold border-border/60 hover:bg-muted/50 border-2">
                ...
                <div className="col-span-9 space-y-6">
                  ...
                  <div className="p-8 md:p-12 rounded-4xl bg-white/5 backdrop-blur-3xl border border-white/10 shadow-2xl">
                    <h3 className="text-4xl md:text-6xl font-black tracking-tighter text-white italic mb-6">
                      Tu taller, <span className="text-primary">potenciado.</span>
                    </h3>
      ...
      <section id="features" className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center space-y-4 mb-20">
            <h2 className="text-4xl md:text-5xl font-black tracking-tight">Todo lo que tu taller necesita.</h2>
            <p className="text-xl text-muted-foreground font-medium">Arquitectura profesional para negocios que buscan excelencia.</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((f, i) => (
              <Card key={i} className="group border-none shadow-xl glass-card hover:bg-muted/20 transition-all duration-500 overflow-hidden">
                <CardContent className="p-10 space-y-6">
                  <div className={cn("inline-flex p-5 rounded-2xl shadow-inner group-hover:scale-110 transition-transform duration-500", f.bg, f.color)}>
                    {f.icon}
                  </div>
      ...
      {/* Pricing Section */}
      <section id="planes" className="py-32 bg-muted/30 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center space-y-4 mb-20">
            <Badge className="bg-primary/10 text-primary border-primary/20 font-bold uppercase tracking-widest px-4 py-1">Inversión Inteligente</Badge>
            <h2 className="text-4xl md:text-5xl font-black tracking-tight">Planes diseñados para crecer.</h2>
          </div>
            ...
            {plans.map((p, i) => (
              <div key={i} className={cn(
                ...
                <div className="space-y-2 mb-8 text-center sm:text-left">
                  <h4 className={cn("text-xl font-black italic", p.highlight ? "text-primary" : "text-foreground")}>{p.name}</h4>
                ...
                <ul className="space-y-5 mb-10 flex-grow">
                  {p.features.map((feat, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-sm font-bold">
                      ...
                      <span className={p.highlight ? "text-white/90" : "text-muted-foreground"}>{feat}</span>
                    </li>
                  ))}
                </ul>
                ...
                <Button 
                  ...
                  className={cn(
                    ...
                    p.highlight ? "shadow-xl shadow-primary/30" : "hover:bg-primary/5 hover:text-primary hover:border-primary/40"
                  )}
                >
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto relative group">
          ...
          <Card className="relative p-12 md:p-20 text-center space-y-10 rounded-[3rem] border-none shadow-3xl bg-linear-to-br from-primary to-blue-700 overflow-hidden group">
            ...
            <p className="text-white/60 text-xs font-mono uppercase tracking-[0.2em]">v1.0.0 Global Release</p>
          </Card>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-lg font-black tracking-tighter">AppTaller</span>
            </div>
